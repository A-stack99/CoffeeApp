  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.container1}>
        <TouchableOpacity
          onPress={() => {setDeliveryType("OrderDelivery"); navigation.navigate('OrderDelivery')}}
          style={styles.containerButton}
          
        >
          <Text style={styles.container1Text}>Deliver</Text>
        </TouchableOpacity>

        <TouchableOpacity
        onPress={() => setDeliveryType("OrderPick")}
          style={[styles.containerButton, styles.activeButton]}
        >
