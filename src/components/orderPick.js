...
// const OrderPick = ({ navigation }) => {
//   const [deliveryType, setDeliveryType] = useState("OrderPick");
...
//       <View style={styles.container1}>
//         <TouchableOpacity
//           style={[styles.containerButton, deliveryType === "Delivery" && styles.activeButton]}
//           onPress={() => setDeliveryType("Delivery")}
//         >
//           <Text style={[styles.container1Text, deliveryType === "Delivery" && styles.activeButtonText]}>Deliver</Text>
//         </TouchableOpacity>

//         <TouchableOpacity
//           style={[styles.containerButton, deliveryType === "Pick Up" && styles.activeButton]}
...
//       {/* Edit Address Modal */}
//       <Modal visible={isEditAddressVisible} transparent={true} animationType="slide">
//         <View style={styles.modalContainer}>
//           <View style={styles.modalContent}>
//             <Text>Edit your address:</Text>
//             <TextInput 
//               style={styles.input} 
//               placeholder="Enter new address" 
//               // Handle input changes here
//             />
//             <Button title="Save" onPress={() => setEditAddressVisible(false)} />
//             <Button title="Cancel" onPress={() => setEditAddressVisible(false)} />
//           </View>
//         </View>
//       </Modal>

//       {/* Add Note Modal */}
//       <Modal visible={isAddNoteVisible} transparent={true} animationType="slide">
//         <View style={styles.modalContainer}>
//           <View style={styles.modalContent}>
...
//               // Handle input changes here
//             />
//             <Button title="Save Note" onPress={() => setAddNoteVisible(false)} />
//             <Button title="Cancel" onPress={() => setAddNoteVisible(false)} />
//           </View>
//         </View>
//       </Modal>
...
// // export default Order; // This line is removed to avoid multiple default exports
